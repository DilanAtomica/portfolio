        ...
        <div className="aboutContainer">
            ...
            <div className="aboutContainer-content">
                ...
                <div className="aboutContainer-textBox">
                    <p>My name is Dilan and I'm a 23 year old student currently living in Kristiansand, Norway. Im in my third year at University of Agder, studying IT and information-systems.
